...
function session($name = '', $value = '')
{
    ...
    if (is_array($name)) {
        ...
        if (C('SESSION_TYPE')) {
            ...
            $hander = new $class();
            if (method_exists($class, 'create_sid') ||
                method_exists($class, 'create_sid') &&
                method_exists($class, 'validate_sid') &&
                method_exists($class, 'update_timestamp')
            ) {
                session_set_save_handler($hander);
            } else {
